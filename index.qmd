...
palettes <- lapply(palette, function(color, n = 5) {colorRampPalette(c("#FFFFFF", color))(n)}, n = 5)

binning <- function(n, color) {
...
bins_hc <- function(n, color, title = NULL, bin_labels = NULL, pct = FALSE, hover = NULL, axis_label = NULL) {
  ...
  bins <- bin_data$values %>% 
    ...
    as.data.frame() %>% 
    filter(`.` != "#333333") %>%
    mutate(color = factor(`.`, levels = palettes[[color]])) %>%
    select(-`.`) %>%
    arrange(color) %>%
...
leaflet(data = dallas_smallgeo, 
  ...
  addPolygons(
    ...
    data = metrics$sdf[[1]],
    fillColor = ~colorBin(palette = palettes[[1]], domain = c(0, max(metrics$sdf[[1]]$all, na.rm = TRUE)))(all),
    fillOpacity = 0.5, 
  ...
  addPolygons(
    group = "rent-burden",
    data = metrics$sdf[[2]],
    fillColor = ~colorNumeric(palette = palettes[[2]], domain = c(0, max(metrics$sdf[[2]]$all, na.rm = TRUE) ))(all),
    fillOpacity = 0.5,
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
     highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    ...
    data = metrics$sdf[[3]],
    fillColor = ~colorNumeric(palette = palettes[[3]], domain = c(0, max(metrics$sdf[[3]]$all, na.rm = TRUE) ))(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    ...
    data = metrics$sdf[[4]],
    fillColor = ~colorNumeric(palette = palettes[[4]], domain = c(0, max(metrics$sdf[[4]]$all, na.rm = TRUE) ))(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    group = "health-index",
    data = metrics$sdf[[6]],
    fillColor = ~colorNumeric(palette = palettes[[6]], domain = c(min(metrics$sdf[[6]]$all, na.rm = TRUE), max(metrics$sdf[[6]]$all, na.rm = TRUE) ), na.color = "#a4a6ab")(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    ...
    data = metrics$sdf[[7]],
    fillColor = ~colorNumeric(palette = palettes[[7]], domain = c(min(metrics$sdf[[7]]$all, na.rm = TRUE), max(metrics$sdf[[7]]$all, na.rm = TRUE) ), na.color = "#a4a6ab")(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    ...
    data = metrics$sdf[[8]],
    fillColor = ~colorNumeric(palette = palettes[[8]], domain = c(min(metrics$sdf[[8]]$all, na.rm = TRUE), max(metrics$sdf[[8]]$all, na.rm = TRUE) ), na.color = "#a4a6ab")(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    group = "pub-commute",
    data = metrics$sdf[[9]],
    fillColor = ~colorNumeric(palette = palettes[[1]], domain = c(min(metrics$sdf[[9]]$all, na.rm = TRUE), max(metrics$sdf[[9]]$all, na.rm = TRUE) ), na.color = "#a4a6ab")(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
  ...
  addPolygons(
    group = "priv-commute",
    data = metrics$sdf[[10]],
    fillColor = ~colorNumeric(palette = palettes[[2]], domain = c(min(metrics$sdf[[10]]$all, na.rm = TRUE), max(metrics$sdf[[10]]$all, na.rm = TRUE) ), na.color = "#a4a6ab")(all),
    fillOpacity = 0.5, 
    stroke = TRUE, color = "#333333", weight = 1.5, opacity = 0.1,
    highlight = highlightOptions(
                opacity = 0.5,
    ...
    popup = paste0(
        ...
        "<b>Percent using public commute:</b> ", scales::percent(metrics$sdf[[10]]$all, accuracy = 0.1)
      )
  ) %>%
