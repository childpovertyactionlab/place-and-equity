                ...
                <div id="demographics" class="accordion-collapse collapse show" data-bs-parent="#overview">
                  <div class="accordion-body">
                    ...
                    <div class="list-group">
                      ...
                      <a href="#" class="list-group-item list-group-item-action" aria-expanded="false" data-bs-toggle="collapse">
                      ...
                      <a href="#" class="list-group-item list-group-item-action" aria-expanded="false" data-toggle="list" data-bs-toggle="collapse">
                        <div class="button-content" id="lang">
                          <span class="left-content">Primary language spoken at home...</span>
                          <div class="button-content-details">
                            <hr>
...
leaflet(data = dallas_tracts, 
  ...
  #   function() {
  #     var map-overview = this;
  #     var legends = map-overview.controls._controlsById;
  #     function addActualLegend() {
  #       var sel = $('.leaflet-control-layers-base').find('input[type=\"radio\"]:checked').siblings('span').text().trim();
  #       $.each(map-overview.controls._controlsById, function(nm) {
  #         map-overview.removeControl(map-overview.controls.get(nm));
  #       });
  #       map-overview.addControl(legends[sel]);
  #     }
...
```{=html}
        ...
        <div class="grid" style="--bs-columns: 3;">
          <div class="g-col-1">
            <h2 class="slim" id="metrics">Metrics</h2>
            <!-- <div class="accordion" id="metrics"> -->
            <!--   <div class="accordion-item"> -->
            <!--     <b class="accordion-header"> -->
            <!--       <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#human-development" aria-expanded="true" aria-controls="human-development"> -->
            <!--         Human Development -->
            <!--       </button> -->
            <!--     </b> -->
            <!--     <div id="human-development" class="accordion-collapse collapse show" data-bs-parent="#metrics"> -->
            <!--       <div class="accordion-body"> -->
            <!--         <div class="list-group"> -->
            <!--           <a href="#human-development" class="list-group-item list-group-item-action" aria-expanded="false" onclick="toggleContent(this)"> -->
            <!--             <div class="button-content" id="housing-quality-and-affordability"> -->
            <!--               <span class="left-content">Housing quality & affordability</span> -->
            <!--               <span class="right-content"> -->
            <!--                 `r scales::comma(acs_place$pop_total[1])` -->
            <!--               </span> -->
            <!--             </div> -->
            <!--           </a> -->
            <!--           <a href="#human-development" class="list-group-item list-group-item-action" aria-expanded="false" onclick="toggleContent(this)"> -->
            <!--             <div class="button-content" id="healthy-family-and-individuals"> -->
            <!--               <span class="left-content">Healthy family and individuals</span> -->
            <!--               <div class="button-content-details"> -->
            <!--                 <hr> -->
            <!--                 <span class="left-content-indent">White</span> -->
            <!--                 <span class="right-content"> -->
            ...
            <!--             </div> -->
            <!--           </a> -->
            <!--           <a href="#" class="list-group-item list-group-item-action" aria-expanded="false" onclick="toggleContent(this)"> -->
            <!--             <div class="button-content" id="lang"> -->
            <!--               <span class="left-content">Primary language spoken at home...</span> -->
            <!--               <div class="button-content-details"> -->
            <!--                 <hr> -->
            ...
            <!--   <div class="accordion-item"> -->
            <!--     <b class="accordion-header"> -->
            <!--       <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#indicators" aria-expanded="false" aria-controls="indicators"> -->
            <!--         Indicators -->
            <!--       </button> -->
            <!--     </b> -->
            <!--     <div id="indicators" class="accordion-collapse collapse" data-bs-parent="#overview"> -->
            <!--       <div class="accordion-body"> -->
            ...
            <!--       </button> -->
            <!--     </b> -->
            <!--     <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#overview"> -->
            <!--       <div class="accordion-body"> -->
...
leaflet(data = dallas_smallgeo, 
  ...
  # Layers control
  addLayersControl(
    baseGroups = c("None", metrics$Metric)
  ) 
# %>%
#   htmlwidgets::onRender("
#     function() {
#       var map-metrics = this;
#       var legends = map-metrics.controls._controlsById;
#       function addActualLegend() {
#         var sel = $('.leaflet-control-layers-base').find('input[type=\"radio\"]:checked').siblings('span').text().trim();
#         $.each(map-metrics.controls._controlsById, function(nm) {
#           map-metrics.removeControl(map-metrics.controls.get(nm));
#         });
#         map-metrics.addControl(legends[sel]);
#       }
#       $('.leaflet-control-layers-base').on('click', addActualLegend);
#       addActualLegend();
#     }
